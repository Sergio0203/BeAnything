...
struct CreditsView: View {
    ...
    var text = "O Dream Gap ou Lacuna dos Sonhos começa por volta dos 6 anos quando as meninas começam a desenvolver crenças autolimitantes e pensam que não são tão inteligentes e capazes quanto os meninos. Elas param de acreditar que seu gênero pode ser qualquer profissão que quiserem. Desejamos inspirar o potencial ilimitado das meninas, através da encenação, para que elas possam se inspirar e se imaginar em diferentes profissões e papéis. Devemos fornecer as meninas representatividade e estímulo ao seu potencial criativo para dimuir a Lacuna dos Sonhos."
