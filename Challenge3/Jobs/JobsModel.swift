...
struct DataBase {
    static var listJobs: [JobsModel] = [
        JobsModel(image: Image(.presidenta), story: "Olá, presidente! Hoje é seu primeiro dia. Você está pronta para ajudar e resolver os problemas do país?\n\nSenhora Presidente, os alunos de várias escolas estão sem livros. O que você gostaria de fazer para garantir que todos tenham os livros de que precisam?", name: "A Presidente", description: ["A presidente é chefe de um país", "Ela ajuda as pessoas do país", "Ela fala em nome do país em eventos importantes"]),
        JobsModel(image: Image( .cientista), story: "Olá, cientista! Hoje é um dia muito emocionante no laboratório. Estamos tentando descobrir uma cura para uma doença.\n\nRecebemos algo que poderá nos ajudar, mas não sabemos o que é. Como você vai investigar e descobrir o que é?", name: "A Cientista", description: ["Faz pesquisas e experimentos", "Descobre coisas novas", "Resolve probelmas importantes"]),
        ...
        JobsModel(image: Image( .astronauta), story: "Olá, astronauta! Hoje é um dia muito importante para nossa missão espacial. Estamos prestes a explorar um novo planeta.\n\nEstamos nos aproximando de um novo planeta com sinais de vida. Como você vai explorar e estudar este novo mundo?", name: "A Astronauta", description: ["Viaja pelo Universo", "Pilota seu próprio foguete", "Ela usa roupa espacial para andar"]),
        JobsModel(image: Image(.atleta), story: "Olá, atleta! Você é a Capitã do time de vôlei! Hoje é o dia da grande final do campeonato mundial de vôlei.\n\nSeu time está perdendo por poucos pontos. O que você vai dizer aos companheiros para motivá-los a dar o melhor de si?", name: "A Atleta", description: ["Ela é rápida e destemida", "Trabalha em equipe", "Ganha medalhas em campeonatos"]),
